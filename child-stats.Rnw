...
d <- KIP %>% select(school, pid, welle, lsat, treated, sat.friends, sat.class, classsit.prob, classsit.excl, female, note.deu, note.mat, note.mus)
...
welle1 <- d %>% filter(welle==1) %>% 
  select(school, pid, welle, lsat, treated, sat.friends, sat.class, classsit.prob, classsit.excl, female, note.deu, note.mat, note.mus)
